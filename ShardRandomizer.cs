...
namespace textcopier2
{
    class ShardRandomizer
    {
        ...
        public static EnemyDropTable CannonMorte100 = new EnemyDropTable
        {
            ShardId = "FireCannon",
            ShardRate = "100.0",
        ...
        public static EnemyDropTable Giermund = new EnemyDropTable
        {
        ...
        public static EnemyDropTable eeeooo = new EnemyDropTable
        {
        ...
        public static EnemyDropTable Poltegeist = new EnemyDropTable
        {
        ...
        public static EnemyDropTable Bloodless = new EnemyDropTable
        {
            ShardId = "Bloodsteel",
            ShardRate = "100.0",
        ...
        public static List<EnemyDropTable> CreateEnemyList()
        {

            //make a list of all the enemies.  currently missing GluttonTrain and OD.
            List<EnemyDropTable> ListOfAllEnemies = new List<EnemyDropTable>
            {
                Seama, Aello, CannonMorte, Ghost, Dullahammer, GiantRat, BoneMorte, Bat,
                Giermund, eeeooo, Sabnock, MocoWeed, Toad, PlumeParma, Barbatos, Carabose, Simian, Zagan,
                Poltegeist, Ordog, Gargoyle, KillerBarber, Demon, Buer, Nyabon,
                ScytheMite, DullahammerHead, BuerArmor, Wolfman, 
                Decarabia, ShovelArmor, ThunderElemental, CarrageMorte, Dantalion, RulSha, Malediction,
                Celano, ShieldOutsider, Lili, Assassin, Dragon, Kunekune, PoisonToad, 
                Sidhe, BomberMorte, Mimic, Puppy, ChairMimic, Lierja, BloodBringer,
                LanceArmor, TomokoDeath, TriwheelBuer, Gamigin, Titania, AxeOutsider, 
                EightBitGhost, EightbitZombie, EightBitSkull, EightBitOverlord, 
                LightElemental, Ocypete, Cyreath, Clam, Forneus, Deaseama, WaterLeaper, Glyshlyn, Seeker, Archdemon, 
                Amy, Firebuer, Vulsha, Rocky, LivingFossle, DarkElemental, Lamashtu, Macaron, 
                Deathtrap, FireElmental, VolcanoMorte, Hellhound, Zepar, BloodBug,
                Gusian, Gapp, Haagenti, Ninja, Kamakazi, 
                GiantMocoWeed, GiantBat, GiantToad, GiantCannon, GiantMorte, GiantBuer, SilverWolfman, AbyssalDragon, Marbas, Harrier, 
                ChariotBuer, IceElemental, Tracer, GussianCannon, GAxeOutsider, DemonLord, 
                Carpenter, Revenant, Revenant2, MillionareBane,
                Vepar, Bloodless, Craftwork, Bathin, Gremory, Andrealphus, Orobos, Doppleganger, Valefar, Valic
            };
        ...
        //This function expects a list of enemies, the string array that contains the json to edit, and a the spoiler log. possibly make spoiler an optional overload.
        public static void WriteShardsToDataTable(List<EnemyDropTable> listofenemies , string[]datatable, List<string> spoilerlog)
        {
        ...
        public static List<EnemyDropTable> GenerateEarlyEnemiesList(List<EnemyDropTable> listofenemies)
        {
            List<EnemyDropTable> earlylogicmovement = new List<EnemyDropTable>();
            for (int i = 0; i < listofenemies.Count(); i++)
            {
                if (listofenemies[i].EarlyEnemy == true)
                {
                    earlylogicmovement.Add(listofenemies[i]);
                }
            }

            return earlylogicmovement;
        }
